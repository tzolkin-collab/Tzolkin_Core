...
test('separate web and API preserve cookies, CSRF, logout and static isolation',async()=>{
 ...
 try {
  ...
  for(const asset of ['/app.js','/product-payments.js','/checkout-gateway.js','/delivery.js','/delivery.css','/style.css','/logo.svg','/favicon.svg','/favicon.ico','/manifest.webmanifest','/icon-192.png','/apple-touch-icon.png','/logos/nubank.svg','/logos/itau.svg','/logos/stripe.svg'])assert.equal((await request(asset)).status,200);
